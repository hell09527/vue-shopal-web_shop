<template>
  <div id="order" ref="order">
    ...
    <select name=""  @change="become($event)" >
        ...
        <div class="order-item" v-for="(item, index) in picList" :key="index">
          <div class="order-item-wrapper">
            ...
            <div class="item">
              ...
              <div class="tho" @click.prevent="dlorder(item.orderNo)">删除</div>
            </div>
...
<script type='text/ecmascript-6'>
  ...
  import {getOrder,delOrder} from '../../axios/order/index'
  ...
  export default{
    data(){
      return {
        selected: '1',
        picList:[],
          citys:[{id:1,name:"订单成功"},{id:2,name:"订单删除"},{id:3,name:"订单"}],
          status:''
